...
// Force dynamic rendering for all admin pages (they require auth and shouldn't be pre-rendered)
...
const sidebarLinks = [
  ...
  { name: 'Product Preview', href: '/admin/product-preview', icon: Image },
  { name: 'Social Proof', href: '/admin/social-proof', icon: Sparkles },
